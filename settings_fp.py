...
FLOOR_PLAN_EDITOR_URL = "/_solara/static/public/floorplaneditor.html"
            ...
            with solara.Column(style={**OUTER_CARD, "flex": "1", "min-width": "400px"}):
                ...
                with solara.Column(style=INNER_CARD):
                    ...
                    solara.HTML(
                        tag="div",
                        unsafe_innerHTML=(
                            f'<a href="{FLOOR_PLAN_EDITOR_URL}" target="_blank" '
                            f'rel="noopener noreferrer" style="display:block;'
                            f'background:{PALETTE["accent"]};color:{PALETTE["text"]};'
                            f'border-radius:22px;padding:12px 24px;text-align:center;'
                            f'font-weight:700;text-decoration:none;font-size:14px;">'
                            f'create own floor plan</a>'
                        ),
                    )
